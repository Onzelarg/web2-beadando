            ...
            <div class="offcanvas-body align-items-center justify-content-center">
              ...
              <ul class="navbar-nav align-items-center mb-2 mb-lg-0">
                <li class="nav-item px-3">
                  <a class="nav-link active p-0" aria-current="page" href="<?php print $menuk[6][0] ?>.html"><?php print $menuk[6][1] ?></a>
                </li>
                ...
                <li class="nav-item px-3 dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end animate slide mt-3 border-0 shadow">
                    ...
                    <li><a href="<?php print $menuk[0][0] ?>.html" class="dropdown-item "><?php print $menuk[0][1] ?> </a>
                    </li>

                    <li><a href="<?php print $menuk[1][0] ?>.html" class="dropdown-item "><?php print $menuk[1][1] ?> </a>
                    </li>
                ...
                <li class="nav-item px-3">
                  <a class="nav-link p-0" href="<?php print $menuk[2][0] ?>.html"><?php print $menuk[2][1] ?></a>
                </li>

                <li class="nav-item px-3">
                  <a class="nav-link p-0" href="<?php print $menuk[3][0] ?>.html"><?php print $menuk[3][1] ?></a>
                </li>

                <li class="nav-item px-3">
                  <a class="nav-link p-0" href="<?php print $menuk[4][0] ?>.html"><?php print $menuk[4][1] ?></a>
                </li>

                <li class="nav-item px-3">
                  <a class="nav-link p-0" href="<?php print $menuk[5][0] ?>.html"><?php print $menuk[5][1] ?></a>
                </li>
